...
class MainTabBar: UITabBarController {
    ...
    func setTabBar() {
        ...
        let profileVC = self.instantiateVC(appStoryboard: .profile, vc: ProfileVC.self)
        profileVC.setTabBarItem("profile".localized, UIImage(systemName: "person"), selectedImage: UIImage(systemName: "person.fill"))
        
        self.setViewControllers([moviesVC, peopleVC, favoriteVC, profileVC], animated: false)
    }
